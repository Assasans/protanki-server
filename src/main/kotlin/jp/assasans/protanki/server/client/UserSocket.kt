  ...
  suspend fun handle() {
    ...
    try {
      while(!(input.isClosedForRead || input.isClosedForWrite)) {
        ...
        val packet = String(buffer)

        val packets = packet.split(Command.Delimiter)
        for(packet in packets) {
            ...
            when(command.name) {
                ...
                send(
                  Command(
                    ...
                    mutableListOf(
                      ...
                      //   InitBonusesDataData(
                      //     bonuses = listOf(
                      //       BonusData(lighting = BonusLightingData(color = 6250335), id = "nitro", resourceId = 170010),
                      //       BonusData(lighting = BonusLightingData(color = 7185722), id = "armor", resourceId = 170006),
                      //       BonusData(
                      ...
                      //         resourceId = 170007
                      //       ),
                      //       BonusData(lighting = BonusLightingData(color = 15044128), id = "gold", resourceId = 170008)
                      //     )
                      //   )
                      // )
                    )
                ...
                send(
                  Command(
                    ...
                    mutableListOf(
                      ...
                      //   InitBattleModelData(
                      //     map_id = "map_aleksandrovsk",
                      //     mapId = 88387,
                      //     battleId = "1",
                      //     skybox = "{\"top\":45572,\"front\":57735,\"back\":268412,\"bottom\":31494,\"left\":927961,\"right\":987391}",
                      //     map_graphic_data = "{\"mapId\":\"map_aleksandrovsk\",\"mapTheme\":\"SUMMER\",\"angleX\":-0.8500000238418579,\"angleZ\":2.5,\"lightColor\":13090219,\"shadowColor\":5530735,\"fogAlpha\":0.25,\"fogColor\":10543615,\"farLimit\":10000,\"nearLimit\":5000,\"gravity\":1000,\"skyboxRevolutionSpeed\":0,\"ssaoColor\":2045258,\"dustAlpha\":0.75,\"dustDensity\":0.15000000596046448,\"dustFarDistance\":7000,\"dustNearDistance\":5000,\"dustParticle\":\"summer\",\"dustSize\":200}"
                      //   )
                      // )
                    )
                  )
              ...
              CommandName.Ping                 -> {
                if(!battleInit) {
                  ...
                  send(
                    Command(
                      ...
                      mutableListOf(
                        ...
                        //         deaths = 7
                        //       ),
                        //       // DmStatisticsUserData(uid = "Luminate", rank = 16, score = 456, kills = 777, deaths = 333)
                        //     )
                        //   )
                        // )
                      )
                  ...
                  //     mutableListOf(json.adapter(SpawnTankData::class.java).toJson(SpawnTankData()))
                  //   )
                  // )
                }
          ...
          GlobalScope.launch { yaebal() }
        }
      }

      println("${socket.remoteAddress} end of data")
